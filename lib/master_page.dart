...
class MasterPageWidget extends StatefulWidget {
  ...
  final AppPageController appPageController;
...
class _MasterPageWidgetState extends State<MasterPageWidget> {
  ...
  void initState() {
    ...
    if (widget.appPageController != null) widget.appPageController._addListener(setVisible: _setVisible);
